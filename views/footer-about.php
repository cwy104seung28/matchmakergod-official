<footer class="relative lg:px-8 lg:pt-14 xl:zoom-80 lg:pb-8">
	...
	<div class="relative pr-3 overflow-hidden lg:hidden">
		<img src="images/footer-box-white.svg" class="relative z-10">
		<img src="images/footer-box-blue.svg" class="absolute -top-2 left-5">
	...
	<div class="absolute top-[36%] bottom-0 inset-x-[270px] z-20 lg:relative lg:top-0 lg:inset-x-0">
		<div class="flex items-start justify-between lg:flex-col lg:items-center">
			<img src="images/blue-footer-logo.svg" class="lg:h-[74px] lg:mb-8">
			...
			<div class="flex items-end gap-14 lg:block lg:w-full">
				<ul class="grid grid-rows-4 grid-flow-col place-content-start gap-x-16 gap-y-4 lg:grid-cols-4 lg:grid-rows-2 lg:gap-x-4 lg:gap-y-2 lg:mb-12"
					...
					<li v-for="p,i in posts" class="cursor-pointer" v-on:click="goto(p.anchor)">
						<div class="text-[26px] tracking-wide text-blue-1000 basic-hover lg:text-sm lg:tracking-normal">
							<a :href="p.link">
								{{p.title}}
							</a>
						</div>
				...
				<nav class="flex gap-5 justify-end mb-2 lg:hidden">
					<a href="javascript:;" class="basic-hover">
						<img src="images/blue-fb.svg">
					</a>

					<a href="javascript:;" class="basic-hover">
						<img src="images/blue-ig.svg">
					</a>
				</nav>
			</div>
		</div>
		...
		<div
			...
			<div class="flex">
				...
				<div class="title text-blue-1000 text-lg lg:text-sm font-bold lg:font-semibold tracking-wide lg:tracking-normal font-en mr-4 lg:mr-5">Tel.</div>
				<div class="phone text-blue-1000 text-lg lg:text-sm font-bold lg:font-semibold tracking-wide lg:tracking-normal font-en mr-4"><a href="tel:+886-4-22434146" target="_blank">04-22434146</a></div>
				<div class="phone text-blue-1000 text-lg lg:text-sm font-bold lg:font-semibold tracking-wide lg:tracking-normal font-en"><a href="tel:0800-221-988" target="_blank">0800-221-988</a></div>
			</div>

			<!-- <img src="images/fax.svg" class="lg:zoom-80"> -->
			<div class="flex">
				<div class="title text-blue-1000 text-lg lg:text-sm font-bold lg:font-semibold tracking-wide lg:tracking-normal font-en mr-4">Fax.</div>
				<div class="phone text-blue-1000 text-lg lg:text-sm font-bold lg:font-semibold tracking-wide lg:tracking-normal font-en"><a href="tel:+886-4-22476921" target="_blank">04-22476921</a></div>
			</div>
			<!-- <img src="images/address.svg" class="lg:zoom-75 lg:ml-[10px]"> -->
			<div class="text-blue-1000 text-lg font-semibold lg:text-sm tracking-wide lg:tracking-normaltracking-wide">
		...
		<a href="https://www.goods-design.com.tw/" target="_blank"
			class="block absolute -right-40 bottom-7 lg:static text-blue-1000 text-[10px] lg:text-[8px] font-normal tracking-normal">
